...
export const DEFAULT_HOMEPAGE_SECTIONS: HomepageSectionSeed[] = [
  {
    ...
    secondary_cta_label_en: "Find a Gift",
    secondary_cta_label_ar: "اختار هدية",
    secondary_cta_href: "/gifts",
  ...
  },
  {
    ...
    primary_cta_label_en: "View all",
    primary_cta_label_ar: "عرض الكل",
    primary_cta_href: "/products",
    sort_order: 20,
    active: true,
    payload: {
  ...
  },
  {
    ...
    primary_cta_label_en: "See all feelings",

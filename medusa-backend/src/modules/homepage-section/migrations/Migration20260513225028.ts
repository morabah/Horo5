...
export class Migration20260513225028 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table if exists "storefront_homepage_section" drop constraint if exists "storefront_homepage_section_key_unique";`);
    ...
    this.addSql(`CREATE INDEX IF NOT EXISTS "IDX_storefront_homepage_section_active_sort_order" ON "storefront_homepage_section" ("active", "sort_order") WHERE deleted_at IS NULL;`);
  }

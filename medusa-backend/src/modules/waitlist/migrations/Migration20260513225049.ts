...
export class Migration20260513225049 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table if exists "storefront_waitlist" drop constraint if exists "storefront_waitlist_email_unique";`);
    this.addSql(`create table if not exists "storefront_waitlist" ("id" text not null, "email" text not null, "locale" text not null default 'en', "source" text not null default 'unknown', "referral_code" text null, "referral_count" integer not null default 0, "coupon_code" text null, "notified_at" timestamptz null, "unsubscribed_at" timestamptz null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "storefront_waitlist_pkey" primary key ("id"));`);

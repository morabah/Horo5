...
export const DICTIONARY = {
  "en": {
    ...
    "home": {
      ...
      "heroScrollCue": "Explore the Drop",
      "heroSecondaryCta": "See the Details",
      "heroGiftCta": "Shop gifts",
      "feelingsEyebrow": "The feelings",
      "feelingsTitle": "Shop by Feeling",
      "feelingsSubtitle": "Start with the feeling. Then choose the design.",
      "meaningZodiacTitle": "Zodiac Signs",
      "meaningZodiacSubtitle": "12 designs",
      "meaningMoodTitle": "Mood",
      ...
      "editorialCloserLookEyebrow": "A Closer Look",
      "editorialCloserLookTitle": "Calm Inside",
      "editorialCloserLookBody": "Artwork, fit, and print details in one closer view.",
      ...
      "routesFoundingDropLabel": "Shop the Drop",
      ...
      "routesWalkAloneLabel": "Walk Alone",
      "routesWalkAloneBlurb": "For those who choose their own path.",
      "routesICareLabel": "I Care",
      "routesICareBlurb": "For the ones who feel deeply.",
      "routesIDontCareLabel": "I Don't Care",
      "routesIDontCareBlurb": "For the ones who own their freedom.",
      "featuredPiecesTitle": "Featured Pieces",
      "featuredPiecesViewAll": "View all",
      "seenOnYouFollowUs": "Follow us",
      ...
      "startHereSubline": "",
      "startHereViewAll": "Shop the Drop",
      "heroTertiaryCta": "See the Details",
      "foundingCampaignCta": "Shop the Drop",
      "foundingGridViewAll": "Shop All Designs",
      "foundingCloserLookCta": "See the Details",
      "startHereCta": "View Details",
      "startHereAddCta": "Add to cart",
      "feelingsRhythmEyebrow": "START WITH YOUR RHYTHM",
      // Legacy: "feelingsCta": "See all feelings",
      "feelingsCta": "Shop the Drop",
      ...
      "giftBody": "A feeling they'll wear.",
      "ourStoryEyebrow": "OUR STORY",
      "ourStoryTitle": "We are the canvas. You are the story.",
      "ourStoryBody": "",
      ...
      "serviceTrust": {
        ...
        "delivery": {
          ...
          "body": "Cairo & Giza often 2–5 business days; other governorates 3–7. Shipping cost shows in cart after you pick your area.",
          "href": "/faq"
        },
        "exchange": {
      ...
      "footerNewsletterBody": "First access to drops, launch stories, and WhatsApp size help before you order.",
      "shopTheLookTitle": "Shop the look",
      "shopTheLookCta": "Shop the look",
      ...
      "featuredPieceCta": "View Design",
      "featuredPieceBrowseAll": "Shop the Drop",
    ...
    "nav": {
      ...
      "shopPreviewTitle": "Shop the Drop",
      "shopPreviewBrowseAll": "Shop All",
      "shopPreviewPlaceholder": "Product image"
    },
    "cartService": {
    ...
    "pdp": {
      ...
      "reviewsSoonNoLinks": "WhatsApp and Instagram appear here once support URLs are set in your site env.",
      ...
      "relatedMoreFromSubtitle": "Other launch pieces from the same meaning group.",
      "styleItWithTitle": "Style it with",
      "styleItWithSubtitle": "Pieces that pair across the founding drop.",
      ...
      "pdpCompleteTheGiftEyebrow": "Complete the gift",
      "pdpRelatedEyebrow": "Discovery",
      "pdpRelatedMoreFromTitle": "More from the Founding Drop",
      "pdpRelatedMoreFromTemplate": "More from the Founding Drop",
      "pdpRelatedBrowseCta": "Shop the Drop",
      "pdpRelatedFallbackFeeling": "this launch",
    ...
    "cart": {
      ...
      "emptyBody": "Your bag is empty. Browse the founding drop and add a design in your size when you're ready.",
    ...
    "about": {
      "lead": "HORO is a wearable-art brand from Egypt. We turn feelings, identity, and personal meaning into artist-made pieces you can live in.",
      "support": "We choose artwork with intention, print in Egypt with visible proof, and keep fit details, size help, and service dependable from first order to delivery.",
      "launchDrop": "The first HORO drop starts with Sign Capsule, Mood, and Lifestyle designs — one launch collection, many ways to wear what you feel.",
      "rhythmLine": "HORO moves with personal rhythm — ritual, connection, and wearing art that matches how you feel.",
      "primaryCta": "Shop the Drop",
      "bridgeCta": "Browse the Drop",
  ...
  "ar": {
    ...
    "home": {
      ...
      "heroPrimaryCta": "تسوّق الإطلاق",
      "heroScrollCue": "استكشف الإطلاق",
      "heroSecondaryCta": "شاهد التفاصيل",
      "heroGiftCta": "تسوّق الهدايا",
      "feelingsEyebrow": "المشاعر",
      "feelingsTitle": "تسوّق حسب الشعور",
      "feelingsSubtitle": "ابدأ بالشعور. ثم اختر التصميم.",
      "meaningZodiacTitle": "الأبراج",
      "meaningZodiacSubtitle": "١٢ تصميم",
      "meaningMoodTitle": "مزاج",
      ...
      "editorialCloserLookEyebrow": "نظرة أقرب",
      "editorialCloserLookTitle": "هدوء من جوّه",
      "editorialCloserLookBody": "تفاصيل الرسمة، المقاس، والطباعة في نظرة واحدة أقرب.",
      ...
      "routesFoundingDropLabel": "تسوّق الإطلاق",
      ...
      "routesWalkAloneLabel": "امشي لوحدك",
      "routesWalkAloneBlurb": "لمن يختار طريقه بنفسه.",
      "routesICareLabel": "اهتم",
      "routesICareBlurb": "لمن يشعر بعمق.",
      "routesIDontCareLabel": "مش فارق",
      "routesIDontCareBlurb": "لمن يملك حريته.",
      "featuredPiecesTitle": "قطع مختارة",
      "featuredPiecesViewAll": "عرض الكل",
      "seenOnYouFollowUs": "تابعنا",
      "routesBrowseAll": "عرض كل تصاميم الإطلاق",
      "startHereEyebrow": "الإطلاق الأول",
      "startHereTitle": "فن قابل للّبس للأبراج والمزاج والقصص الشخصية.",
      "startHereSubline": "",
      "startHereViewAll": "تسوّق الإطلاق",
      "heroTertiaryCta": "شاهد التفاصيل",
      "foundingCampaignCta": "تسوّق الإطلاق",
      "foundingGridViewAll": "تسوّق كل التصاميم",
      "foundingCloserLookCta": "شاهد التفاصيل",
      "startHereCta": "شاهد التفاصيل",
      "startHereAddCta": "أضف إلى السلة",
      "feelingsRhythmEyebrow": "ابدأ بإيقاعك",
      "feelingsCta": "تسوّق الإطلاق",
      ...
      "giftEyebrow": "لما تهدي",
      "giftHeadline": "أكثر من هدية.",
      "giftHeadlineLine2": "إحساس هيلبسوه.",
      "giftBody": "إحساس هيلبسوه.",
      "ourStoryEyebrow": "قصتنا",
      "ourStoryTitle": "إحنا القماش. إنت القصة.",
      "ourStoryBody": "",
      ...
      "serviceTrust": {
        "fitGuide": {
          "title": "تفاصيل المقاس واضحة",
          "body": "دليل مقاسات ومراجع عارضين على كل صفحة منتج.",
          "href": "/size-guide"
        },
        "delivery": {
          "title": "توصيل في مصر",
          "body": "القاهرة والجيزة غالباً ٢–٥ أيام عمل؛ باقي المحافظات ٣–٧. تكلفة الشحن تظهر في السلة بعد اختيار المحافظة.",
          "href": "/faq"
        },
        "exchange": {
          "title": "استبدال سهل",
      ...
      "footerNewsletterBody": "أول وصول للإصدارات وقصص الإطلاق ومساعدة المقاس على واتساب قبل الطلب.",
      "shopTheLookTitle": "كمّل اللوك",
      "shopTheLookCta": "تسوّق اللوك",
      ...
      "featuredPieceCta": "شاهد التصميم",
      "featuredPieceBrowseAll": "تسوّق الإطلاق",
    ...
    "nav": {
      ...
      "shopPreviewTitle": "تسوّق الإطلاق",
      "shopPreviewBrowseAll": "تسوّق الكل",
      "shopPreviewPlaceholder": "صورة المنتج"
    },
    "search": {
    ...
    "pdp": {
      ...
      "reviewsSoonWhatsappCta": "WhatsApp us",
      "reviewsSoonInstagramCta": "Instagram",
      "reviewsSoonNoLinks": "واتساب وإنستغرام يظهران هنا بعد ضبط روابط الدعم في إعدادات الموقع.",
      "crossSellBundleFbtCta": "Add pair to bag",
      "crossSellBundleStyleCta": "Add outfit to bag",
      "crossSellNeedSize": "Choose a size first to add bundles.",
      "crossSellBundleAdded": "Bundle added — open bag to review.",
      ...
      "pdpCompleteTheGiftEyebrow": "أكمل الهدية",
      "pdpRelatedEyebrow": "Discovery",
      "pdpRelatedMoreFromTitle": "المزيد من الإطلاق الأول",
      "pdpRelatedMoreFromTemplate": "المزيد من الإطلاق الأول",
      "pdpRelatedBrowseCta": "تسوّق الإطلاق",
      "pdpRelatedFallbackFeeling": "هذا الإطلاق",
      "pdpRelatedCardSrTemplate": "View {name}, {price}",
      "sizeGuidePresetEyebrow": "Guide preset",
      "sizeGuideTableSize": "Size",
      "sizeGuideTableChest": "Chest",
    ...
    "cart": {
      "heading": "Your cart",
      "emptyCta": "تسوّق الإطلاق",
      "primaryCta": "إتمام الدفع",
      "secondaryCta": "متابعة التسوّق",
      "orderSummaryHeading": "Order summary",
      ...
      "bundleUpsellBody": "Pick one more design by a different artist and get 100 EGP off.",
      "bundleUpsellCta": "Browse designs →",
      "emptyBody": "سلتك فارغة. تصفّح الإطلاق الأول وأضف تصميماً بمقاسك عندما تكون جاهزاً.",
      "quantityUpdated": "Quantity updated for {name}.",
      "quantityMinReached": "{name} is already at the minimum quantity.",
      "itemRemoved": "{name} removed from your cart.",
      "removeUndoPrompt": "{name} removed.",
    ...
    "about": {
      "lead": "HORO علامة فنية قابلة للّبس من مصر. نحوّل المشاعر والهوية والمعنى الشخصي إلى قطع فنية يرتديها الفنانون.",
      "support": "نختار الفن بعناية، ونطبع في مصر مع دليل واضح، ونحافظ على تفاصيل المقاس والمساعدة والخدمة من أول طلب حتى التوصيل.",
      "launchDrop": "يبدأ الإطلاق الأول بكبسولة الأبراج، المزاج، ونمط الحياة — مجموعة إطلاق واحدة وطرق متعددة لارتداء ما تشعر به.",
      "rhythmLine": "HORO تتحرك مع إيقاعك — طقس، اتصال، وفن تلبسه يطابق شعورك.",
      "primaryCta": "تسوّق الإطلاق",
      "bridgeCta": "تصفّح الإطلاق",
      "heroRegionLabel": "HORO story hero",
      "bridgeRegionLabel": "HORO collection bridge"
    },
    "quickView": {
      "openCta": "نظرة سريعة",
      "openAriaTemplate": "نظرة سريعة: {name}",
      "closeLabel": "إغلاق النظرة السريعة",
      "chooseSizeCta": "اختار المقاس",
      "addToBagCta": "أضف للسلة — {price}",
      "viewBagCta": "عرض السلة",
      "continueBrowsingCta": "متابعة التصفّح",
      "viewFullProductCta": "عرض صفحة المنتج",
      "sizeChartLabel": "جدول المقاسات",
      "sizeChartRegionLabel": "Quick view size chart",
      "addedStatus": "Added to bag."
    }
  }

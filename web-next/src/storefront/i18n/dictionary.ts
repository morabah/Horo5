...
export const DICTIONARY = {
  "en": {
    "shell": {
      ...
      "shopAllIntro": "The first HORO drop — Zodiac, I Care, I Don't Care, and Walk Alone.",
    ...
    "home": {
      ...
      "routesFoundingDropBlurb": "Start with the full launch drop — Zodiac, I Care, I Don't Care, and Walk Alone.",
      ...
      "startHereSubline": "Zodiac, I Care, I Don't Care, and Walk Alone — limited first run.",
  ...
  "ar": {
    ...
    "home": {
      ...
      "routesFoundingDropBlurb": "ابدأ بإطلاق HORO الكامل — برج، اهتم، مش فارق، وامشي لوحدك.",
      ...
      "startHereSubline": "برج، اهتم، مش فارق، وامشي لوحدك — إطلاق محدود.",
    ...
    "pdp": {
      ...
      "pdpPrimaryCtaAddedLabel": "Added to bag",
      "styleItWithEyebrow": "Pairing",
      "pdpZodiacCapsuleLabel": "مجموعة الرموز",
      "pdpRelatedEyebrow": "Discovery",
      "pdpRelatedMoreFromTemplate": "More from {feeling}",
      "pdpRelatedFallbackFeeling": "this feeling",
      "pdpRelatedCardSrTemplate": "View {name}, {price}",

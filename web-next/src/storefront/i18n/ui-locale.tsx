...
const UI_COPY = {
  en: {
    ...
    home: {
      ...
      trustBadges: {
        premiumCotton: '180 gsm Premium Cotton',
        printedEgypt: 'Made Real in Egypt',
        codExchange: 'COD + 14-Day Exchange',
        artistSigned: 'Artist-Signed Print',
      },
      ...
      whyHoroBlocks: {
        ...
        heavyweightQuality: {
          title: '180 gsm Cotton, Built to Last',
          body: 'Heavyweight fabric, DTG print that holds colour through washes, and a hand-feel you notice the moment you put it on.',
        },
        personalMeaning: {
  ...
  ar: {
    ...
    home: {
      ...
      trustBadges: {
        premiumCotton: 'قطن ١٨٠ جرام فاخر',
        printedEgypt: 'صُنع فعلاً في مصر',
        codExchange: 'دفع عند الاستلام + استبدال 14 يوم',
        artistSigned: 'طباعة موقّعة من الفنان',
      },
      ...
      whyHoroBlocks: {
        ...
        heavyweightQuality: {
          title: 'قطن ١٨٠ جرام، مصنوع ليدوم',
          body: 'قماش ثقيل، طباعة تحتفظ بلونها بعد الغسيل، وإحساس تلاحظه من أول مرة ترتديه.',
        },
        personalMeaning: {
          title: 'ارتدِ ما تشعر به',

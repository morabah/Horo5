...
const UI_COPY = {
  en: {
    ...
    home: {
      ...
      behindThePieceCards: [
        { title: 'Artwork direction', body: 'Each design starts with an Egyptian illustrator. The concept, sketch, and final art are credited on the product page.' },
        { title: 'Printed in Egypt', body: 'We prepare and print locally to keep quality visible and shipping honest. No overseas dropshipping claims.' },
        { title: 'Fit and care details', body: 'Every product page shows measurements, fit notes, and care instructions before you buy.' },
      ],
  ...
  ar: {
    ...
    home: {
      ...
      behindThePieceCards: [
        { title: 'توجيه الرسمة', body: 'كل تصميم بيبدأ برسّام مصري. الفكرة، المسودة، والتصميم النهائي مذكورين في صفحة المنتج.' },
        { title: 'مطبوع في مصر', body: 'بنحضّر ونطبع محلياً عشان الجودة تكون واضحة والشحن يكون صريح. مفيش ادعاءات دروبشيب من برّه.' },
        { title: 'مقاسات وعناية', body: 'كل صفحة منتج بتعرض المقاسات، ملاحظات القصة، وتعليمات العناية قبل الشراء.' },
      ],

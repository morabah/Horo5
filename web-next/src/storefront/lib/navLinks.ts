...
export const NAV_PRIMARY_ROUTE_KEYS = ['products', 'collection', 'gifts', 'about'] as const;

export type NavRouteKey = keyof typeof NAV_ROUTE;

export const NAV_DRAWER_ROUTE_KEYS = ['home', 'products', 'collection', 'gifts', 'occasions', 'about', 'search'] as const;

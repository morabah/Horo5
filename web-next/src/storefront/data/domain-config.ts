...
export const PDP_SCHEMA = {
  ...
  trustStripItems: ['Artist-made design', 'Licensed art', '14-day exchange — see policy', 'Cash on delivery (COD) available'] as const,
...
export const CART_SCHEMA = {
  trustStripItems: ['14-day exchange — see policy', 'Cash on delivery (COD) available', 'Artist-made design'] as const,

} as const;

export const MINI_CART_SCHEMA = {

  trustItems: ['14-day exchange — see policy', 'Cash on delivery (COD) available', 'Secure checkout'] as const,

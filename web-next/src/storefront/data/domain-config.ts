...
export const PDP_SCHEMA = {
  ...
  copy: {
    ...
    illustratedByLabelAr: 'رسم',
    verifiedArtistLabel: 'Verified Artist',
    verifiedArtistLabelAr: 'فنان موثّق',
...
export const CART_SCHEMA = {
  ...
  copy: {
    ...
    whatsappSizeHelpLabelAr: 'محتاج مساعدة في المقاس؟ تواصل معنا',
...
export const OCCASION_SCHEMA = {
  copy: {
    ...
    hubGridEyebrowAr: 'ابدأ من هنا',
    hubGridTitle: 'Gift it, mark it, wear it — pick the moment',
    hubGridTitleAr: 'اهدِها، سجّلها، ارتديها — اختر المناسبة',
...
export const VIBES_SCHEMA = {
  copy: {
    ...
    hubGridTitleAr: 'تصفّح حسب الشعور، ثم فلتر داخل',
